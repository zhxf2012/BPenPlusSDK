#
#  Be sure to run `pod spec lint BPenPlusSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "zhouxingfa" => "zhouxingfa@bibibettre.com" }
  # Or just: spec.author    = "zhouxingfa"
  # spec.authors            = { "zhouxingfa" => "zhouxingfa@bibibettre.com" }
  # spec.social_media_url   = "https://twitter.com/zhouxingfa"
  ...
  spec.source       = { :git => "https://github.com/zhxf2012/BPenPlusSDK.git", :tag => "#{spec.version}" }
  ...
  spec.dependency 'BPBleOTA', '~> 0.7.2'
